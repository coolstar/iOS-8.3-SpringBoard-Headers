...
@class NSString, SBControlCenterSettings, UIPanGestureRecognizer, UITapGestureRecognizer, NSMutableArray, SBControlCenterContentView, SBControlCenterContainerView;
