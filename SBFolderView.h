...
@class NSString, _UILegibilitySettings, SBFakeStatusBarView, SBIconListView, UITapGestureRecognizer, UIView, SBIconScrollView, NSMutableSet, NSArray, NSMutableArray, SBFolderTitleTextField, SBFolder, UISwipeGestureRecognizer, SBIconListPageControl, SBIconViewMap;
