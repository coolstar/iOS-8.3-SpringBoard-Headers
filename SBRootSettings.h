...
@class NSString, SBHomeButtonSettings, SBIconColorSettings, SBCarDisplaySettings, SBControlCenterSettings, SBNotificationCenterSettings, SBFolderSettings, SBLockScreenSettings, SBRootAnimationSettings, SBFAnimationFactorySettings, SBLockScreenTestPluginSettings, SBAppSwitcherSettings, SBReachabilitySettings, SBLockScreenSlideUpAppSettings, SBAppParallaxSettings, SBAlertItemsSettings, SBFWallpaperSettings, SBLegibilitySettings, SBFadeAnimationSettings;
