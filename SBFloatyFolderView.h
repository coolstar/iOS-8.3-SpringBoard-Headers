...
@class NSString, SBFloatyFolderBackgroundClipView, SBFolderSettings, UITapGestureRecognizer, NSMutableArray, UIPinchGestureRecognizer, UILongPressGestureRecognizer, NSMapTable;
