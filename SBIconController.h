...
@class NSString, _UILegibilitySettings, SBIconColorSettings, NSTimer, NSIndexPath, UITouch, SBLeafIcon, SBIcon, NSMutableSet, NSMutableArray, SBRootFolderController, SBIconModel, BBObserver, SBIconContentView, NSSet, SBFolder;
