...
@class NSString, _UILegibilitySettings, UIScreen, SBIconModel, NSMapTable;
...
-(void)invalidate;
-(void)dealloc;
-(id)initWithIconModel:(id)iconModel screen:(id)screen delegate:(id)delegate viewDelegate:(id)delegate4;
@end
