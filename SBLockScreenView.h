...
@class SBLockScreenTimerView, SBLockScreenBounceAnimator, NSMutableArray, _UILegibilitySettings, SBSlideUpAppGrabberView, _UIGlintyStringView, _UIBackdropView, SBFakeStatusBarView, SBWallpaperEffectView, SBFLockScreenDateView, SBLockScreenScrollView, UIView, UIScrollView, SBSlideToUnlockFailureRecognizer, UIColor, NSSet, NSString, NSCountedSet, SBLockScreenBatteryChargingView, SBLockOverlayStylePropertiesFactory, NSMutableSet, SBDisableAppStatusBarAlphaChangesAssertion, SBChevronView;
@protocol SBLegibility, _SBFVibrantView, SBUIPasscodeLockView, SBLockScreenViewDelegate;
