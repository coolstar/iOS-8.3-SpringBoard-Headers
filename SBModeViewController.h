...
@class NSString, UIView, NSArray, UIViewController, UIScrollView, SBNotificationSeparatorView, SBModeControlManager, SBBulletinObserverViewController, UISwipeGestureRecognizer;
