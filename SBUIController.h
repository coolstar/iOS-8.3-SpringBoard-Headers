...
@class NSString, UIView, NSMutableSet, NSArray, NSMutableArray, NSMutableDictionary, SBAppSwitcherWindowController, SBAppSwitcherController, FBWorkspaceEventQueueLock, SBWindow, SBSwitchAppGestureView, SBDismissOnlyAlertItem, FBUIApplicationResignActiveAssertion, SBAnimationStepper, SBApplication, UIStatusBar;
