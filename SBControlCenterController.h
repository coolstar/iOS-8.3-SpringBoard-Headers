...
@class NSString, _UIBackdropView, SBControlCenterRootView, UIDynamicAnimator, UIView, NSHashTable, NSMutableSet, SBControlCenterViewController, UIImageView, SBWindow, NSSet, FBUIApplicationResignActiveAssertion, _UIDynamicValueAnimation, SBChevronView;
