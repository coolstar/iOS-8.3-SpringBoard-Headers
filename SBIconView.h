...
@class NSString, _UILegibilitySettings, SBFParallaxSettings, NSTimer, SBIconImageCrossfadeView, UIView, SBIcon, SBCloseBoxView, SBIconImageView, SBIconLabelView, SBFolderIconBackgroundView;
