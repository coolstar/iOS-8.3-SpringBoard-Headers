...
@class NSString, SBLockScreenViewController, UIWindow, SBLockScreenTestPluginSettings, SBLockScreenPlugin, NSMutableDictionary, SBLockScreenPluginLoader, SBLockScreenPluginTransitionFactory;
