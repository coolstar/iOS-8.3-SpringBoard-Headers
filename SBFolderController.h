...
@class NSString, _UILegibilitySettings, NSTimer, SBIcon, NSArray, SBFolderControllerAnimationContext, SBIconAnimator, SBFolderView, SBFolderContext, SBFolder, NSMapTable, SBIconViewMap;
