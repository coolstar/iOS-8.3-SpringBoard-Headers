...
@class FBProcessState, BKSApplicationDataStore, NSTimer, NSDictionary, NSMutableArray, UIRemoteApplication, BKSProcessAssertion, NSMutableDictionary, BSMachSendRight, NSDate, FBApplicationInfo, NSHashTable, SBActivationSettings, FBApplicationProcess, PCPersistentTimer, CLLocationManager, NSSet, NSMapTable, NSString, BSCFBundle, SBStateSettings, NSArray, SBDeactivationSettings, NSMutableSet;
