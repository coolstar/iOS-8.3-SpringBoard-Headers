...
@class NSString, SBAppSwitcherScrollView, UITapGestureRecognizer, NSMutableSet, NSArray, NSMutableDictionary, NSMutableArray, SBDisplayItem, SBStopScrollingGestureRecognizer;
