...
@class NSString, UIScreen, SBDeactivationSettings, SBAlertManager, SBStateSettings, SBAlertView, NSHashTable, UIViewController, NSMutableDictionary, SBActivationSettings;
