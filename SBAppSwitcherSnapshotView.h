...
@class NSString, UIView, NSObject, UIImage, SBAppSwitcherSettings, SBSnapshotImageInfo, SBWallpaperEffectView, SBAppSwitcherStatusBarViewCache, SBZoomableCrossfadeView, UIImageView, SBApplication, SBDisplayItem;
