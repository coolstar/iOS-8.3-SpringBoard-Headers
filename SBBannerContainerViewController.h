...
@class NSString, SBBannerContextView, SBBannerContainerView, UIView, SBUIBannerContext, UIImage, NCContentHostViewController, NCBannerAccessoryHostViewController, SBBannerButtonViewController, NCInteractiveNotificationHostViewController, FBUIApplicationResignActiveAssertion;
