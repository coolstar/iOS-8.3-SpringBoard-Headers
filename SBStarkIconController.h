...
@class NSString, _UILegibilitySettings, SBStarkFakeIconOperationController, NSIndexPath, SBStarkIconLayoutOverrideStrategy, SBIcon, SBIconModel, SBStarkFolderController, SBIconViewMap;
